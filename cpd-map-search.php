...
add_shortcode('cpd_map_search_form', array('CPDMapSearch', 'form'));

add_action('wp_ajax_cpd_map_search', array('CPDMapSearch', 'ajax'));
add_action('wp_ajax_nopriv_cpd_map_search', array('CPDMapSearch', 'ajax'));
